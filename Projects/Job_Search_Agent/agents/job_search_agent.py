...
search_agent = Agent(
    name="JobSearchAgent",
    instructions=(
       "You are a job discovery bot. Given a job-related search query, return a JSON object with up to 10 job listings from Linkedin , Hirist, or Naukri which are latest and most recent "
